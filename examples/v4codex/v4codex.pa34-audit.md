...
Perform an independent review using the `spec.md` architecture audit checklist
...
cause and fix it. Support performance and memory conclusions with comparative
host-seeded and self-built evidence.
